...
/**
 * LISTA DE ACCIONES ADOPTADAS POR CADA ATENCION
 */
...
public class Accadoate implements Serializable {
    ...
    public Accadoate nUsuareg(Integer nUsuareg) {
    ...
    public Accadoate tFecreg(Instant tFecreg) {
    ...
    public Accadoate nFlgactivo(Boolean nFlgactivo) {
    ...
    public Accadoate nSedereg(Integer nSedereg) {
    ...
    public Accadoate nUsuaupd(Integer nUsuaupd) {
    ...
    public Accadoate tFecupd(Instant tFecupd) {
    ...
    public Accadoate nSedeupd(Integer nSedeupd) {
    ...
    public Accadoate atencion(Atencion atencion) {
    ...
    public Accionadop getAccionadop() {
        return accionadop;
    }

    public Accadoate accionadop(Accionadop accionadop) {
        this.accionadop = accionadop;
        return this;
    }

    public void setAccionadop(Accionadop accionadop) {
        this.accionadop = accionadop;
    }
    ...
    public boolean equals(Object o) {
        ...
        Accadoate accadoate = (Accadoate) o;
        if (accadoate.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), accadoate.getId());
    }
