...
/**
 * LISTA MAESTRA DE ACCIONES ADOPTADAS
 */
@ApiModel(description = "LISTA MAESTRA DE ACCIONES ADOPTADAS")
@Entity
...
public class Accionadop implements Serializable {
    ...
    /**
     * DESCRIPCION DE LA ACCION ADOPTADA.
     */
    @NotNull
    @Size(max = 100)
    @ApiModelProperty(value = "DESCRIPCION DE LA ACCION ADOPTADA.", required = true)
