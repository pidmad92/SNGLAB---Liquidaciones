...
/**
 * LISTA MAESTRA DE CARGOS DE TRABAJADORES
 */
@ApiModel(description = "LISTA MAESTRA DE CARGOS DE TRABAJADORES")
@Entity
@Table(name = "cartrab")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
@Document(indexName = "cartrab")
public class Cartrab implements Serializable {
    ...
    /**
     * DESCRIPCION DEL CARGO DEL TRABAJADOR.
     */
    @NotNull
    @Size(max = 100)
    @ApiModelProperty(value = "DESCRIPCION DEL CARGO DEL TRABAJADOR.", required = true)
    @Column(name = "v_descartra", length = 100, nullable = false)
    private String vDescartra;
    ...
    public String getvDescartra() {
        return vDescartra;
    }

    public Cartrab vDescartra(String vDescartra) {
        this.vDescartra = vDescartra;
        return this;
    }

    public void setvDescartra(String vDescartra) {
        this.vDescartra = vDescartra;
    }
    ...
    public Cartrab nUsuareg(Integer nUsuareg) {
    ...
    public Cartrab tFecreg(Instant tFecreg) {
    ...
    public Cartrab nFlgactivo(Boolean nFlgactivo) {
    ...
    public Cartrab nSedereg(Integer nSedereg) {
    ...
    public Cartrab nUsuaupd(Integer nUsuaupd) {
    ...
    public Cartrab tFecupd(Instant tFecupd) {
    ...
    public Cartrab nSedeupd(Integer nSedeupd) {
    ...
    public Cartrab trabajadors(Set<Trabajador> trabajadors) {
        this.trabajadors = trabajadors;
        return this;
    }

    public Cartrab addTrabajador(Trabajador trabajador) {
        this.trabajadors.add(trabajador);
        trabajador.setCartrab(this);
        return this;
    }

    public Cartrab removeTrabajador(Trabajador trabajador) {
        this.trabajadors.remove(trabajador);
        trabajador.setCartrab(null);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        Cartrab cartrab = (Cartrab) o;
        if (cartrab.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), cartrab.getId());
    }
