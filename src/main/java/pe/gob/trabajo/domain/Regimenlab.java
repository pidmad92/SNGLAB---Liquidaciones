...
/**
 * LISTA MAESTRA DE LOS REGIMENES LABORALES
 */
...
public class Regimenlab implements Serializable {
    ...
    /**
     * DESCRIPCION DEL REGIMEN LABORAL.
     */
    @NotNull
    @Size(max = 100)
    @ApiModelProperty(value = "DESCRIPCION DEL REGIMEN LABORAL.", required = true)
    @Column(name = "v_desreglab", length = 100, nullable = false)
    private String vDesreglab;
    ...
    public String getvDesreglab() {
        return vDesreglab;
    }

    public Regimenlab vDesreglab(String vDesreglab) {
        this.vDesreglab = vDesreglab;
        return this;
    }

    public void setvDesreglab(String vDesreglab) {
        this.vDesreglab = vDesreglab;
    }
    ...
    public Regimenlab nUsuareg(Integer nUsuareg) {
    ...
    public Regimenlab tFecreg(Instant tFecreg) {
    ...
    public Regimenlab nFlgactivo(Boolean nFlgactivo) {
    ...
    public Regimenlab nSedereg(Integer nSedereg) {
    ...
    public Regimenlab nUsuaupd(Integer nUsuaupd) {
    ...
    public Regimenlab tFecupd(Instant tFecupd) {
    ...
    public Regimenlab nSedeupd(Integer nSedeupd) {
    ...
    public Regimenlab datlabs(Set<Datlab> datlabs) {
        this.datlabs = datlabs;
        return this;
    }

    public Regimenlab addDatlab(Datlab datlab) {
        this.datlabs.add(datlab);
        datlab.setRegimenlab(this);
        return this;
    }

    public Regimenlab removeDatlab(Datlab datlab) {
        this.datlabs.remove(datlab);
        datlab.setRegimenlab(null);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        Regimenlab regimenlab = (Regimenlab) o;
        if (regimenlab.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), regimenlab.getId());
    }
