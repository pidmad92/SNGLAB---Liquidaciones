...
/**
 * LISTA MAESTRA DE TIPOS DE PERSONA
 */
...
public class Tippersona implements Serializable {
    ...
    @NotNull
    @Size(max = 100)
    @ApiModelProperty(value = "DESCRIPCION DEL TIPO DE PERSONA.", required = true)
    @Column(name = "v_destipper", length = 100, nullable = false)
    private String vDestipper;
    ...
    public String getvDestipper() {
        return vDestipper;
    }

    public Tippersona vDestipper(String vDestipper) {
        this.vDestipper = vDestipper;
        return this;
    }

    public void setvDestipper(String vDestipper) {
        this.vDestipper = vDestipper;
    }
    ...
    public Tippersona nUsuareg(Integer nUsuareg) {
    ...
    public Tippersona tFecreg(Instant tFecreg) {
    ...
    public Tippersona nFlgactivo(Boolean nFlgactivo) {
    ...
    public Tippersona nSedereg(Integer nSedereg) {
    ...
    public Tippersona nUsuaupd(Integer nUsuaupd) {
    ...
    public Tippersona tFecupd(Instant tFecupd) {
    ...
    public Tippersona nSedeupd(Integer nSedeupd) {
    ...
    public Tippersona empleadors(Set<Empleador> empleadors) {
        this.empleadors = empleadors;
        return this;
    }

    public Tippersona addEmpleador(Empleador empleador) {
        this.empleadors.add(empleador);
        empleador.setTippersona(this);
        return this;
    }

    public Tippersona removeEmpleador(Empleador empleador) {
        this.empleadors.remove(empleador);
        empleador.setTippersona(null);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        Tippersona tippersona = (Tippersona) o;
        if (tippersona.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), tippersona.getId());
    }
